...
function App() {
  ...
  useEffect(() => {
    axios.get(`${API_BASE}/tecs`).then((res) => setTecs(res.data));
  }, []);
  ...
  useEffect(() => {
    ...
    axios
      .get(`${API_BASE}/carreras`, { params: { tecId: filtroTec } })
  ...
  const buscarMaterias = () => {
    ...
    axios.get(`${API_BASE}/materias`, { params }).then((res) => {
      setMaterias(res.data);

      // recalcula gráfico con la nueva búsqueda
      calcularGrafico(res.data);
