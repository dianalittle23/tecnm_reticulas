// backend/seed_materias_ITMexicali_igem_2009_201.js
//
...
// Materias extraídas de la retícula IGEM-2009-201
...
const materiasDatos = [
  ...
  // Nota: Las materias de especialidad (30 créditos restantes) varían y no se detallan en la retícula genérica.
...
async function main() {
  try {
    ...
    console.log("Materias de Ingeniería en Gestión Empresarial IGEM-2009-201 guardadas.");
  } catch (err) {
