// backend/seed_materias_ITnortedenayarit_igem_2009_201.js
//
// Inserta materias de Ingeniería en Gestión Empresarial IGEM-2009-201
// del Instituto Tecnológico de norte de nayarit en MongoDB.
...
const TEC_NOMBRE = "Instituto Tecnológico del Norte de Nayarit";
...
async function main() {
  try {
    ...
    console.log("Materias IGEM IT norte de nayarit 2009-201 guardadas.");
  } catch (err) {
