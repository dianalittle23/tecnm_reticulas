// backend/seed_materias_ITmatehuala_igem_2009_201.js
//
// Inserta materias de Ingeniería en Gestión Empresarial IGEM-2009-201
// del Instituto Tecnológico de matehuala en MongoDB.
...
const TEC_NOMBRE = "Instituto Tecnológico de Matehuala";
...
async function main() {
  try {
    ...
    console.log("Materias IGEM IT matehuala 2009-201 guardadas.");
  } catch (err) {
