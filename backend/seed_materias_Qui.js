// backend/seed_materias_IEME_2010_210.js
//
...
const TEC_NOMBRE = "Instituto Tecnológico de Aguascalientes";
// o por ejemplo: "Instituto Tecnológico de Aguascalientes"

const CARRERA_NOMBRE = "Ingeniería Química";
const PLAN_ANIO = 2010;

// Materias extraídas de la retícula IEME-2010-210 (TecNM)
...
const materiasDatos = [
  ...
  },
  {
    semestre_recomendado: 4,
    clave: "EMF-1004",
    nombre: "Análisis de Circuitos Eléctricos de CD",
    cadena_creditos: "3-2-5",
    horas_teoria: 3,
    horas_practica: 2,
    creditos: 5,
  ...
  },
  {
    semestre_recomendado: 5,
    clave: "EMC-1010",
    nombre: "Diseño e Ingeniería Asistidos por Computadora",
    cadena_creditos: "2-2-4",
    horas_teoria: 2,
    horas_practica: 2,
    creditos: 4,
  ...
  },
  {
    semestre_recomendado: 5,
    clave: "EMF-1003",
    nombre: "Análisis de Circuitos Eléctricos de CA",
    cadena_creditos: "3-2-5",
    horas_teoria: 3,
    horas_practica: 2,
    creditos: 5,
  },
  {
    semestre_recomendado: 5,
    clave: "EMJ-1026",
    nombre: "Sistemas y Máquinas de Fluidos",
    cadena_creditos: "4-2-6",
    horas_teoria: 4,
    horas_practica: 2,
    creditos: 6,
  ...
  // ---- Semestre 6 ----
  {
    ...
    clave: "EMC-1018",
    nombre: "Máquinas y Equipos Térmicos I",
    cadena_creditos: "2-2-4",
    horas_teoria: 2,
    horas_practica: 2,
    creditos: 4,
  ...
  },
  {
    semestre_recomendado: 6,
    clave: "EMJ-1001",
    nombre: "Administración y Técnicas de Mantenimiento",
    cadena_creditos: "4-2-6",
    horas_teoria: 4,
    horas_practica: 2,
    creditos: 6,
  ...
  // ---- Semestre 7 ----
  {
    ...
    clave: "EMC-1019",
    nombre: "Máquinas y Equipos Térmicos II",
    cadena_creditos: "2-2-4",
    horas_teoria: 2,
    horas_practica: 2,
    creditos: 4,
  ...
  },
  {
    semestre_recomendado: 7,
    clave: "EMJ-1014",
    nombre: "Ingeniería de Control Clásico",
    cadena_creditos: "4-2-6",
    horas_teoria: 4,
    horas_practica: 2,
    creditos: 6,
  ...
  },
  {
    semestre_recomendado: 8,
    clave: "EMJ-1025",
    nombre: "Sistemas Hidráulicos y Neumáticos de Potencia",
    cadena_creditos: "4-2-6",
    horas_teoria: 4,
    horas_practica: 2,
    creditos: 6,
