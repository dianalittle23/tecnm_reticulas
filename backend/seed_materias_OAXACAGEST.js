// backend/seed_materias_ITOaxaca_igem_2009_201.js
//
// Inserta materias de Ingeniería en Gestión Empresarial IGEM-2009-201
// del Instituto Tecnológico de Oaxaca en MongoDB.
...
const TEC_NOMBRE = "Instituto Tecnológico de Oaxaca";
...
async function main() {
  try {
    ...
    console.log("Materias IGEM IT Oaxaca 2009-201 guardadas.");
  } catch (err) {
