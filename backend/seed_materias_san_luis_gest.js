// backend/seed_materias_ITCDVALLES_igem_2009_201.js
//
...
const TEC_NOMBRE = "Instituto Tecnológico de Ciudad Valles";
...
async function main() {
  try {
    ...
    console.log("Materias IGEM IT ciudad valles 2009-201 guardadas.");
  } catch (err) {
