// backend/seed_materias_ITPinotepa_igem_2009_201.js
//
// Inserta materias de Ingeniería en Gestión Empresarial IGEM-2009-201
// del Instituto Tecnológico de Pinotepa en MongoDB.
...
const TEC_NOMBRE = "Instituto Tecnológico de Pinotepa";
...
async function main() {
  try {
    ...
    console.log("Materias IGEM IT Pinotepa 2009-201 guardadas.");
  } catch (err) {
