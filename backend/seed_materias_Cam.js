// backend/seed_materias_IAMB_2010_206.js
//
// Inserta materias de Ingeniería Ambiental IAMB-2010-206
// del Instituto Tecnológico de Campeche en MongoDB.
...
const TEC_NOMBRE = "Instituto Tecnológico de Campeche";
...
const materiasDatos = [
  ...
  // ---------- Semestre 2 ----------
  {
    ...
    clave: "AEF-1033",
    nombre: "Fundamentos de Química Orgánica",
    cadena_creditos: "3-2-5",
    horas_teoria: 3,
    horas_practica: 2,
    creditos: 5,
  ...
  },
  {
    semestre_recomendado: 2,
    clave: "AMF-1019",
    nombre: "Probabilidad y Estadística Ambiental",
    cadena_creditos: "3-2-5",
    horas_teoria: 3,
    horas_practica: 2,
    creditos: 5,
  ...
  },
  {
    semestre_recomendado: 3,
    clave: "AMC-1005",
    nombre: "Diseño de Experimentos Ambientales",
    cadena_creditos: "2-2-4",
    horas_teoria: 2,
    horas_practica: 2,
    creditos: 4,
  ...
  },
  {
    semestre_recomendado: 6,
    clave: "AMF-1002",
    nombre: "Componentes de Equipo Industrial",
    cadena_creditos: "3-2-5",
    horas_teoria: 3,
    horas_practica: 2,
    creditos: 5,
  ...
  // ---------- Semestre 8 ----------
  {
    ...
    clave: "AMG-1012",
    nombre: "Fundamentos de Aguas Residuales",
    cadena_creditos: "3-3-6",
    horas_teoria: 3,
    horas_practica: 3,
    creditos: 6,
