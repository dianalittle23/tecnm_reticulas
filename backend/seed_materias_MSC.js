// backend/seed_materias_ITMexicali_isic_2010_224.js
//
...
// Materias extraídas de la retícula ISIC-2010-224
...
const materiasDatos = [
  ...
  {
    semestre_recomendado: 1,
    clave: "AED-1285", // Actualización de SCD-1008
  ...
  {
    semestre_recomendado: 2,
    clave: "AED-1286", // Actualización de SCD-1020
...
async function main() {
  try {
    ...
    console.log("Materias de Ingeniería en Sistemas Computacionales ISIC-2010-224 guardadas.");
  } catch (err) {
