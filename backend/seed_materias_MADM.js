// backend/seed_materias_ITMexicali_iadm_2010_213.js
//
...
// Materias extraídas de la retícula IADM-2010-213
...
const materiasDatos = [
  // ---------- Semestre 1 ----------
  {
    ...
    clave: "ADD-1030",
    nombre: "Taller de Administración I",
  ...
  },
  {
    semestre_recomendado: 1,
    clave: "ADD-1013",
    nombre: "Contabilidad Aplicada a la Ingeniería",
    cadena_creditos: "2-3-5",
    horas_teoria: 2,
    horas_practica: 3,
    creditos: 5,
  ...
  // ---------- Semestre 2 ----------
  {
    ...
    clave: "ADD-1031",
    nombre: "Taller de Administración II",
    cadena_creditos: "2-3-5",
    horas_teoria: 2,
    horas_practica: 3,
    creditos: 5,
  },
  {
    semestre_recomendado: 2,
    clave: "ADV-1033",
    nombre: "TIC'S Aplicadas a la Administración",
    cadena_creditos: "0-5-5",
    horas_teoria: 0,
    horas_practica: 5,
    creditos: 5,
  ...
  // ---------- Semestre 3 ----------
  {
    ...
    clave: "ADD-1022",
    nombre: "Innovación Tecnológica I",
    cadena_creditos: "2-3-5",
    horas_teoria: 2,
    horas_practica: 3,
    creditos: 5,
  ...
  },
  {
    semestre_recomendado: 4,
    clave: "ADB-1023",
    nombre: "Innovación Tecnológica II",
  ...
  },
  {
    semestre_recomendado: 6,
    clave: "ADI-1005",
    nombre: "Análisis de la Problemática Nacional",
