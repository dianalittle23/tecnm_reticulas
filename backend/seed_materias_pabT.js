// backend/seed_materias_ITPabellon_itic_2010_225.js
//
// Inserta materias de Ingeniería en TICs ITIC-2010-225
...
async function main() {
  try {
    ...
    console.log(" Materias de Ingeniería en TICs ITIC-2010-225 guardadas.");
  } catch (err) {
