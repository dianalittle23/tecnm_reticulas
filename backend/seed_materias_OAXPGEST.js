// backend/seed_materias_ITPochutla_igem_2009_201.js
//
// Inserta materias de Ingeniería en Gestión Empresarial IGEM-2009-201
// del Instituto Tecnológico de Pochutla en MongoDB.
...
const TEC_NOMBRE = "Instituto Tecnológico de Pochutla";
...
async function main() {
  try {
    ...
    console.log("Materias IGEM IT Pochutla 2009-201 guardadas.");
  } catch (err) {
