// backend/seed_materias_ITcomitancillo_igem_2009_201.js
//
// Inserta materias de Ingeniería en Gestión Empresarial IGEM-2009-201
// del Instituto Tecnológico de comitancillo en MongoDB.
...
const TEC_NOMBRE = "Instituto Tecnológico de Comitancillo";
...
async function main() {
  try {
    ...
    console.log("Materias IGEM IT de comitancillo 2009-201 guardadas.");
  } catch (err) {
