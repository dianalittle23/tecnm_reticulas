// backend/seed_materias_ITCuautla_igem_2009_201.js
//
// Inserta materias de Ingeniería en Gestión Empresarial IGEM-2009-201
// del Instituto Tecnológico de Cuautla en MongoDB.
...
const TEC_NOMBRE = "Instituto Tecnológico de Cuautla";
...
async function main() {
  try {
    ...
    console.log("Materias IGEM IT Cuautla 2009-201 guardadas.");
  } catch (err) {
